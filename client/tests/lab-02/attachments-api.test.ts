...
describe('attachment API client', () => {
  it('uploads FormData with requester context and no manual content type', async () => {
    ...
    await expect(uploadAttachment('TKT-20260904-A1B2C3D4', file))
  ...
  it('sends a trimmed removal intent as JSON to the owned route', async () => {
    ...
    await removeAttachment('TKT-20260904-A1B2C3D4', 7, 'Wrong document')
  ...
  it('requests protected inline/download bytes and preserves safe errors', async () => {
    ...
    await expect(getAttachmentContent('TKT-20260904-A1B2C3D4', 7, 'inline'))
      .resolves.toBe(blob)
    ...
    await expect(getAttachmentContent('TKT-20260904-A1B2C3D4', 7, 'attachment'))
